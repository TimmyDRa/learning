describe('Laboratory Technician', () =>{
    beforeEach(() =>{
      //Logs in with an authorized tenant
            cy.visit('https://test.app.plateaumed-staging.com/');
            cy.get('[data-testid="username"]', {timeout:60000}).type('freijoranninu-3880@yopmail.com');
  ...
  it(`should login as a laboratory technician,
    ...
    console.log("success");
    cy.contains('Laboratory Technician');
     });
